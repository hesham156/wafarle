        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between text-sm">
            <div className="flex items-center gap-4">
              <span>🎉 عروض خاصة على اشتراكات Adobe Creative Suite</span>
              <span>|</span>
              <span>خصم 30% للطلاب</span>
            </div>
            <div className="hidden md:flex items-center gap-4">
              <span>📧 support@wafarle.com</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold text-gray-800 hidden sm:block">وفرلي</span>
            </Link>
              ...
              <div className="flex items-center gap-1">
                <div className="relative group">
                  <Link href="/cart" className="relative">
                    <div className="flex items-center gap-2 p-2 text-gray-700 hover:text-blue-600 transition-colors rounded-lg hover:bg-blue-50">
                      <div className="relative">
                  ...
                  {cartCount > 0 && (
                    <div className="hidden group-hover:block absolute bottom-full left-1/2 transform -translate-x-1/2 mb-3 w-80 bg-white rounded-2xl shadow-2xl border border-gray-100 z-50">
                      {/* Header */}
                      ...
                      <div className="max-h-64 overflow-y-auto p-4">
                        <div className="space-y-3">
                          ...
                          <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                            ...
                            <div className="flex-1 min-w-0">
                              <h4 className="font-medium text-gray-900 text-sm truncate">Adobe Photoshop</h4>
                              <p className="text-gray-500 text-xs">الكمية: 1</p>
                            </div>
                            <div className="text-right">
                              <p className="font-bold text-blue-600 text-sm">$29.99</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                            ...
                            <div className="flex-1 min-w-0">
                              <h4 className="font-medium text-gray-900 text-sm truncate">Premiere Pro</h4>
                              <p className="text-gray-500 text-xs">الكمية: 1</p>
                            </div>
                            <div className="text-right">
                              <p className="font-bold text-green-600 text-sm">$24.99</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="border-t border-gray-100 p-4">
                        ...
                        <div className="flex gap-2">
                          <Link 
                            href="/cart"
                            className="flex-1 bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 px-4 rounded-xl font-medium text-center hover:from-blue-600 hover:to-purple-700 transition-all transform hover:scale-105"
                          >
                            عرض السلة
                          </Link>
                          <Link 
                            href="/checkout"
                            className="flex-1 bg-gray-900 text-white py-3 px-4 rounded-xl font-medium text-center hover:bg-gray-800 transition-all transform hover:scale-105"
                          >
                            إتمام الطلب
                          </Link>
                        </div>
            ...
            {user ? (
                ...
                {isUserMenuOpen && (
                  <div className="absolute left-0 mt-2 w-48 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-50">
                    <div className="px-4 py-2 border-b border-gray-100">
                      <p className="text-sm text-gray-600">مرحباً، {user.user_metadata.full_name || 'المستخدم'}</p>
              ...
              <div className="flex items-center gap-2">
                ...
                <Link
                  href="/auth/register"
                  className="px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl hover:from-blue-600 hover:to-purple-700 transition-all transform hover:scale-105"
                >
                  إنشاء حساب
                </Link>
              </div>
              ...
              <form onSubmit={handleSearchSubmit}>
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="ابحث عن المنتجات..."
                    className="w-full pr-10 pl-3 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
              </form>
