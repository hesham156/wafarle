...
-- 5. إضافة المستخدمين الحاليين (بدون user_metadata)
...
-- 2. سيتم إضافة جميع المستخدمين الحاليين
-- 3. ستظهر صفحة إدارة المستخدمين جميع المستخدمين
-- 4. يمكنك تعديل الأسماء والأدوار لاحقاً من الواجهة
